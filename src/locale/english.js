export const english = {
  ...
  HOME_PARA_1:
    "We have started Care and Cure Clinic located at prime location in Akola city which is easily accessible from City's Bus stand as well as Railway station since March 2021.",
  HOME_PARA_2:
